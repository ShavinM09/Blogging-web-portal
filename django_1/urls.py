...
urlpatterns = [
    ...
    path('eprofile/', user_views.eprofile,name='eprofile'),
    path('password-reset/', auth_views.PasswordResetView.as_view(template_name='users/password_reset.htm'),name='password_reset'),
    path('password-reset/confirm<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='users/password_reset_confirm.htm'),name='password_reset_confirm'),
